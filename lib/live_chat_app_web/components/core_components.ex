defmodule LiveChatAppWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(LiveChatAppWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(LiveChatAppWeb.Gettext, "errors", msg, opts)
    end
  end
